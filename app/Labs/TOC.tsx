...
export default function TOC() {
  ...
  return (
    <Nav variant="pills">
      ...
      <NavItem>
        <NavLink href="https://github.com/kelwand">
          My GitHub</NavLink></NavItem>
      <NavItem>
        <NavLink href="https://github.com/kelwand/kambaz-node-server-app">
          Node Server GitHub Repo </NavLink></NavItem>
      <NavItem>
        <NavLink href="https://kambaz-node-server-app-enzr.onrender.com">
          Live Node Server on Render </NavLink></NavItem>
    </Nav>
  );
}